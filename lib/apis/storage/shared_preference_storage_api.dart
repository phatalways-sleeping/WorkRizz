...
final class SharedPreferenceStorageAPI extends StorageAPI {
  ...
  @override
  Future<void> createNewPersonalSchedule(PersonalScheduleModel personalScheduleModel) {
    throw UnimplementedError();
  }
  ...
  @override
  Stream<PersonalScheduleModel> personalScheduleStreamInPersonalSchedule(String id) {
    throw UnimplementedError();
  }
  ...
  @override
  Future<void> removeMostActiveMembersInProject(String id, List<String> removedItems) {
    throw UnimplementedError();
  }
  
  @override
  Future<void> removePersonalScheduleInUser(String id, List<String> removedItems) {
    throw UnimplementedError();
  }
  ...
  @override
  Future<void> updateMostActiveMembersInProject(String id, List<String> latestVersion) {
    throw UnimplementedError();
  }
  ...
  @override
  Future<void> updatePersonalScheduleInUser(String id, List<String> latestVersion) {
    throw UnimplementedError();
  }
  ...
  @override
  Future<void> updateUserActivity(String id, bool isActive, DateTime lastActive) {
    throw UnimplementedError();
  }
